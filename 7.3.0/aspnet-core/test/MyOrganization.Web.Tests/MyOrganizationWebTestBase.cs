...
{
    public abstract class MyOrganizationWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MyOrganizationWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MyOrganizationWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MyOrganizationDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MyOrganizationDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MyOrganizationDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MyOrganizationDbContext, Task<T>> func)
        {
            T result;
